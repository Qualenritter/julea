...
echo "StopCPUTime = 0.0001" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/CollapseTestNonCosmological/CollapseTestNonCosmological.enzo.tmp
...
benchmark /mnt/julea		0 40 sqlite server hdd 1
benchmark /dev/shm/warnke/julea	1 40 sqlite server mem 1
benchmark /mnt/julea		1 40 sqlite server hdd 1
benchmark /dev/shm/warnke/julea	1 40 mysql  client mem 6
benchmark /mnt/julea		1 40 mysql  client hdd 6
benchmark /dev/shm/warnke/julea	0 40 sqlite server mem 6
benchmark /mnt/julea		0 40 sqlite server hdd 6
