...
#define smd_server_message_exec(func)                                                                                               \
	...
	{                                                                                                                           \
		...
		{                                                                                                                   \
			...
			{                                                                                                           \
				data.out_param[data.out_param_count - 1].ptr = &data.out_param[data.out_param_count - 1].error_ptr; \
				data.out_param[data.out_param_count - 1].error_ptr = NULL;                                          \
			}                                                                                                           \
			else if (data.out_param[i].type == J_SMD_PARAM_TYPE_BSON)                                                   \
			{                                                                                                           \
				data.out_param[data.out_param_count - 1].bson_initialized = FALSE;                                  \
		...
		{                                                                                                                   \
			...
			{                                                                                                           \
				...
				if (ret)                                                                                            \
				{                                                                                                   \
					for (i = 0; i < data.out_param_count - 1; i++)                                              \
					{                                                                                           \
						if (data.out_param[i].type == J_SMD_PARAM_TYPE_BSON)                                \
							data.out_param[data.out_param_count - 1].bson_initialized = TRUE;           \
					}                                                                                           \
				}                                                                                                   \
			}                                                                                                           \
