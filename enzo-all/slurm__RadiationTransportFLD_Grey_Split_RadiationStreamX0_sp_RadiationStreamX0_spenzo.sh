...
thepath=${PWD}
name=slurm__RadiationTransportFLD_Grey_Split_RadiationStreamX0_sp_RadiationStreamX0_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_Grey_Split_RadiationStreamX0_sp_RadiationStreamX0_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/RadiationStreamX0_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/RadiationStreamX0_sp/RadiationStreamX0_sp.enzo
du -sh *
du -sh .
