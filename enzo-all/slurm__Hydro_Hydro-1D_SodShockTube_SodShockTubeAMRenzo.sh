...
echo slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeAMRenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeAMRenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeAMRenzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeAMRenzo
