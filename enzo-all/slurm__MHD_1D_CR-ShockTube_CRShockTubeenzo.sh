...
echo slurm__MHD_1D_CR-ShockTube_CRShockTubeenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__MHD_1D_CR-ShockTube_CRShockTubeenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__MHD_1D_CR-ShockTube_CRShockTubeenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__MHD_1D_CR-ShockTube_CRShockTubeenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__MHD_1D_CR-ShockTube_CRShockTubeenzo
...
cp -r ${HOME}/enzo-dev/run/./MHD/1D/CR-ShockTube/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./MHD/1D/CR-ShockTube/CRShockTube.enzo
du -sh *
du -sh .
