...
echo $(hostname)
echo slurm__Hydro_Hydro-2D_RampedKelvinHelmholtz2D_RampedKelvinHelmholtz2Denzo-0.sh
echo $tmpdir
...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-2D_RampedKelvinHelmholtz2D_RampedKelvinHelmholtz2Denzo-0"
