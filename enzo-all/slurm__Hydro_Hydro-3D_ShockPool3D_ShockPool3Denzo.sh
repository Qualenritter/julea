...
echo slurm__Hydro_Hydro-3D_ShockPool3D_ShockPool3Denzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_ShockPool3D_ShockPool3Denzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_ShockPool3D_ShockPool3Denzo
...
export J_TIMER_DB="${HOME}/julea/slurm__Hydro_Hydro-3D_ShockPool3D_ShockPool3Denzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_ShockPool3D_ShockPool3Denzo
...
cp -r ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/ShockPool3D/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/ShockPool3D/ShockPool3D.enzo
du -sh *
du -sh .
