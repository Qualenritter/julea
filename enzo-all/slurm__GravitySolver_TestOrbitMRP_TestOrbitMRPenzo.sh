...
echo slurm__GravitySolver_TestOrbitMRP_TestOrbitMRPenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__GravitySolver_TestOrbitMRP_TestOrbitMRPenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__GravitySolver_TestOrbitMRP_TestOrbitMRPenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__GravitySolver_TestOrbitMRP_TestOrbitMRPenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__GravitySolver_TestOrbitMRP_TestOrbitMRPenzo
...
cp -r ${HOME}/enzo-dev/run/./GravitySolver/TestOrbitMRP/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./GravitySolver/TestOrbitMRP/TestOrbitMRP.enzo
du -sh *
du -sh .
