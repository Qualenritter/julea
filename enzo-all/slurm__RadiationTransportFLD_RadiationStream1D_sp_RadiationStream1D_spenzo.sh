...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiationStream1D_sp_RadiationStream1D_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiationStream1D_sp_RadiationStream1D_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStream1D_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStream1D_sp/RadiationStream1D_sp.enzo
du -sh *
du -sh .
