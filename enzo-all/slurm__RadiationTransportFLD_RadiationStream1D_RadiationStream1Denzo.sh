...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiationStream1D_RadiationStream1Denzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiationStream1D_RadiationStream1Denzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStream1D/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStream1D/RadiationStream1D.enzo
du -sh *
du -sh .
