...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Enzochem/CosmoIonization_q05z4_enzochem/CosmoIonization_q05z4_enzochem.enzo
du -sh *
du -sh .
