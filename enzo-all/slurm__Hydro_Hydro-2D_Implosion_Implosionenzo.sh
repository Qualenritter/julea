...
echo slurm__Hydro_Hydro-2D_Implosion_Implosionenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-2D_Implosion_Implosionenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-2D_Implosion_Implosionenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__Hydro_Hydro-2D_Implosion_Implosionenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-2D_Implosion_Implosionenzo
...
cp -r ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/Implosion/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/Implosion/Implosion.enzo
du -sh *
du -sh .
