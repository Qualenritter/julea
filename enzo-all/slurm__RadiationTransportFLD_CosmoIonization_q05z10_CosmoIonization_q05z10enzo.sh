...
thepath=${PWD}
name=slurm__RadiationTransportFLD_CosmoIonization_q05z10_CosmoIonization_q05z10enzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_CosmoIonization_q05z10_CosmoIonization_q05z10enzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/CosmoIonization_q05z10/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/CosmoIonization_q05z10/CosmoIonization_q05z10.enzo
du -sh *
du -sh .
