...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiatingShockLab_RadiatingShockLabenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiatingShockLab_RadiatingShockLabenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiatingShockLab/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiatingShockLab/RadiatingShockLab.enzo
du -sh *
du -sh .
