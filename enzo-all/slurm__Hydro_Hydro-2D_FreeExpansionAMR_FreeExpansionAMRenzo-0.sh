...
echo $(hostname)
echo slurm__Hydro_Hydro-2D_FreeExpansionAMR_FreeExpansionAMRenzo-0.sh
echo $tmpdir
...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-2D_FreeExpansionAMR_FreeExpansionAMRenzo-0"
