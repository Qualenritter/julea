...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiationStreamZ0_sp_RadiationStreamZ0_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiationStreamZ0_sp_RadiationStreamZ0_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamZ0_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamZ0_sp/RadiationStreamZ0_sp.enzo
du -sh *
du -sh .
