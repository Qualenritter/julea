...
echo $(hostname)
echo slurm__Hydro_Hydro-2D_Athena-RayleighTaylor_Athena-RayleighTaylorenzo-0.sh
echo $tmpdir
...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-2D_Athena-RayleighTaylor_Athena-RayleighTaylorenzo-0"
