...
echo $(hostname)
echo slurm__Hydro_Hydro-3D_NFWCoolCoreCluster_NFWCoolCoreClusterenzo-0.sh
echo $tmpdir
...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-3D_NFWCoolCoreCluster_NFWCoolCoreClusterenzo-0"
