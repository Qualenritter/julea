...
thepath=${PWD}
name=slurm__FuzzyDarkMatter_FDMCollapseenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__FuzzyDarkMatter_FDMCollapseenzo.sqlite"
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./FuzzyDarkMatter/FDMCollapse.enzo
du -sh *
du -sh .
