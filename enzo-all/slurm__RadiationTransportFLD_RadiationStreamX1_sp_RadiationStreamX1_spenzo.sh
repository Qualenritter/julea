...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiationStreamX1_sp_RadiationStreamX1_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiationStreamX1_sp_RadiationStreamX1_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamX1_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamX1_sp/RadiationStreamX1_sp.enzo
du -sh *
du -sh .
