...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RHIonization1_RHIonization1enzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RHIonization1_RHIonization1enzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RHIonization1/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RHIonization1/RHIonization1.enzo
du -sh *
du -sh .
