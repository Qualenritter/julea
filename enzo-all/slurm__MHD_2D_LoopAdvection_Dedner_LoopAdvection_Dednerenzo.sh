...
echo slurm__MHD_2D_LoopAdvection_Dedner_LoopAdvection_Dednerenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__MHD_2D_LoopAdvection_Dedner_LoopAdvection_Dednerenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__MHD_2D_LoopAdvection_Dedner_LoopAdvection_Dednerenzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__MHD_2D_LoopAdvection_Dedner_LoopAdvection_Dednerenzo
