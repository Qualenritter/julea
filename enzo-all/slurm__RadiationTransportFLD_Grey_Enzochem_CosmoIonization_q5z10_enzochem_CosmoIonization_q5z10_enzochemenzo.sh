...
thepath=${PWD}
name=slurm__RadiationTransportFLD_Grey_Enzochem_CosmoIonization_q5z10_enzochem_CosmoIonization_q5z10_enzochemenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_Grey_Enzochem_CosmoIonization_q5z10_enzochem_CosmoIonization_q5z10_enzochemenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Enzochem/CosmoIonization_q5z10_enzochem/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Enzochem/CosmoIonization_q5z10_enzochem/CosmoIonization_q5z10_enzochem.enzo
du -sh *
du -sh .
