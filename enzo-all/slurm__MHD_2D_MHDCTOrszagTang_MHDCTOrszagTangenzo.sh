...
echo slurm__MHD_2D_MHDCTOrszagTang_MHDCTOrszagTangenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__MHD_2D_MHDCTOrszagTang_MHDCTOrszagTangenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__MHD_2D_MHDCTOrszagTang_MHDCTOrszagTangenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__MHD_2D_MHDCTOrszagTang_MHDCTOrszagTangenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__MHD_2D_MHDCTOrszagTang_MHDCTOrszagTangenzo
...
cp -r ${HOME}/enzo-dev/run/./MHD/2D/MHDCTOrszagTang/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./MHD/2D/MHDCTOrszagTang/MHDCTOrszagTang.enzo
du -sh *
du -sh .
