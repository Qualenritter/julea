...
cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-2D_DoubleMachReflection_DoubleMachReflectionenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-2D_DoubleMachReflection_DoubleMachReflectionenzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-2D_DoubleMachReflection_DoubleMachReflectionenzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/DoubleMachReflection/DoubleMachReflection.enzo
du -sh *
du -sh .
