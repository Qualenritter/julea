...
echo slurm__Hydro_Hydro-3D_CollideTest_CollideTestenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_CollideTest_CollideTestenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_CollideTest_CollideTestenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__Hydro_Hydro-3D_CollideTest_CollideTestenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_CollideTest_CollideTestenzo
...
cp -r ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/CollideTest/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/CollideTest/CollideTest.enzo
du -sh *
du -sh .
