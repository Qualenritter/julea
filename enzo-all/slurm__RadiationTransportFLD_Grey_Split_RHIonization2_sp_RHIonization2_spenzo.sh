...
thepath=${PWD}
name=slurm__RadiationTransportFLD_Grey_Split_RHIonization2_sp_RHIonization2_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_Grey_Split_RHIonization2_sp_RHIonization2_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/RHIonization2_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/RHIonization2_sp/RHIonization2_sp.enzo
du -sh *
du -sh .
