...
echo slurm__CosmologySimulation_dm_only_dm_onlyenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__CosmologySimulation_dm_only_dm_onlyenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__CosmologySimulation_dm_only_dm_onlyenzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__CosmologySimulation_dm_only_dm_onlyenzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./CosmologySimulation/dm_only/dm_only.enzo
du -sh *
du -sh .
