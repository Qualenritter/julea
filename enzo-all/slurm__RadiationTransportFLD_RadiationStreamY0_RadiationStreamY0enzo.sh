...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiationStreamY0_RadiationStreamY0enzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiationStreamY0_RadiationStreamY0enzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamY0/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamY0/RadiationStreamY0.enzo
du -sh *
du -sh .
