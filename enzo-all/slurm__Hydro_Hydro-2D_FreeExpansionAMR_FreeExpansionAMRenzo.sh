...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-2D_FreeExpansionAMR_FreeExpansionAMRenzo"
...
echo "ResubmitCommand = ./run-continue.sh" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/FreeExpansionAMR/FreeExpansionAMR.enzo.tmp

${HOME}/julea/example/a.out

mpirun -np 6 ${HOME}/enzo-dev/src/enzo/enzo.exe ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/FreeExpansionAMR/FreeExpansionAMR.enzo.tmp >> ${J_TIMER_DB_RUN}.out
