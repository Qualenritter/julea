...
thepath=${PWD}
name=slurm__RadiationTransportFLD_Grey_Split_RadiationStreamZ1_sp_RadiationStreamZ1_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_Grey_Split_RadiationStreamZ1_sp_RadiationStreamZ1_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/RadiationStreamZ1_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/RadiationStreamZ1_sp/RadiationStreamZ1_sp.enzo
du -sh *
du -sh .
