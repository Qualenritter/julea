...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-2D_Athena-RayleighTaylor_Athena-RayleighTaylorenzo"
...
mpirun -np 6 ${HOME}/enzo-dev/src/enzo/enzo.exe ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/Athena-RayleighTaylor/Athena-RayleighTaylor.enzo.tmp >> ${J_TIMER_DB_RUN}.out
