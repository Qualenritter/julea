...
thepath=${PWD}
name=slurm__FuzzyDarkMatter_FDMCosmologyenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__FuzzyDarkMatter_FDMCosmologyenzo.sqlite"
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./FuzzyDarkMatter/FDMCosmology.enzo
du -sh *
du -sh .
