...
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__MHD_3D_StochasticForcing_StochasticForcingenzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__MHD_3D_StochasticForcing_StochasticForcingenzo
