...
echo slurm__RadiationTransport_PhotonTestAMR_PhotonTestAMRenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__RadiationTransport_PhotonTestAMR_PhotonTestAMRenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__RadiationTransport_PhotonTestAMR_PhotonTestAMRenzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__RadiationTransport_PhotonTestAMR_PhotonTestAMRenzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransport/PhotonTestAMR/PhotonTestAMR.enzo
du -sh *
du -sh .
