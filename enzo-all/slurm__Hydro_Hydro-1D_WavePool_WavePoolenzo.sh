...
echo slurm__Hydro_Hydro-1D_WavePool_WavePoolenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_WavePool_WavePoolenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_WavePool_WavePoolenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__Hydro_Hydro-1D_WavePool_WavePoolenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_WavePool_WavePoolenzo
...
cp -r ${HOME}/enzo-dev/run/./Hydro/Hydro-1D/WavePool/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-1D/WavePool/WavePool.enzo
du -sh *
du -sh .
