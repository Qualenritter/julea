...
echo $(hostname)
echo slurm__StarParticle_StarParticleSingleTest_TestStarParticleSingleenzo-1.sh
echo $tmpdir
...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__StarParticle_StarParticleSingleTest_TestStarParticleSingleenzo-1"
