...
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__DrivenTurbulence3D_DrivenTurbulence3Denzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__DrivenTurbulence3D_DrivenTurbulence3Denzo

sleep 10s

cat ${HOME}/.config/julea/julea-slurm__DrivenTurbulence3D_DrivenTurbulence3Denzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./DrivenTurbulence3D/DrivenTurbulence3D.enzo
du -sh *
du -sh .
