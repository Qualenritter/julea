...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-2D_SedovBlast_SedovBlastenzo.sqlite"
...
${HOME}/enzo-dev/src/enzo/enzo.exe ${HOME}/enzo-dev/run/./Hydro/Hydro-2D/SedovBlast/SedovBlast.enzo.tmp
