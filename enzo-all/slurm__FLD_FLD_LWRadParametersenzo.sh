...
echo slurm__FLD_FLD_LWRadParametersenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__FLD_FLD_LWRadParametersenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__FLD_FLD_LWRadParametersenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__FLD_FLD_LWRadParametersenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__FLD_FLD_LWRadParametersenzo
...
cp -r ${HOME}/enzo-dev/run/./FLD/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./FLD/FLD_LWRadParameters.enzo
du -sh *
du -sh .
