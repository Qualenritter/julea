...
echo $(hostname)
echo slurm__MHD_3D_StochasticForcing_StochasticForcingenzo-1.sh
echo $tmpdir
...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__MHD_3D_StochasticForcing_StochasticForcingenzo-1"
