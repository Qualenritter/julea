...
echo slurm__GravitySolver_GravityTest_GravityTestenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__GravitySolver_GravityTest_GravityTestenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__GravitySolver_GravityTest_GravityTestenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__GravitySolver_GravityTest_GravityTestenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__GravitySolver_GravityTest_GravityTestenzo
...
cp -r ${HOME}/enzo-dev/run/./GravitySolver/GravityTest/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./GravitySolver/GravityTest/GravityTest.enzo
du -sh *
du -sh .
