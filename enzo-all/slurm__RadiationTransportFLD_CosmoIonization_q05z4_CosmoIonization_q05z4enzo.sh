...
thepath=${PWD}
name=slurm__RadiationTransportFLD_CosmoIonization_q05z4_CosmoIonization_q05z4enzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_CosmoIonization_q05z4_CosmoIonization_q05z4enzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/CosmoIonization_q05z4/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/CosmoIonization_q05z4/CosmoIonization_q05z4.enzo
du -sh *
du -sh .
