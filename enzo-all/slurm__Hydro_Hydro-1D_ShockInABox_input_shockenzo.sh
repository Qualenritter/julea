...
echo slurm__Hydro_Hydro-1D_ShockInABox_input_shockenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_ShockInABox_input_shockenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_ShockInABox_input_shockenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__Hydro_Hydro-1D_ShockInABox_input_shockenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_ShockInABox_input_shockenzo
...
cp -r ${HOME}/enzo-dev/run/./Hydro/Hydro-1D/ShockInABox/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-1D/ShockInABox/input_shock.enzo
du -sh *
du -sh .
