...
thepath=${PWD}
name=slurm__RadiationTransportFLD_Grey_Split_CosmologyFLD_RT_CosmologyFLD_RTenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_Grey_Split_CosmologyFLD_RT_CosmologyFLD_RTenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/CosmologyFLD_RT/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/CosmologyFLD_RT/CosmologyFLD_RT.enzo
du -sh *
du -sh .
