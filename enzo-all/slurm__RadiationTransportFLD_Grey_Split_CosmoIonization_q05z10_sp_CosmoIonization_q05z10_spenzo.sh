...
thepath=${PWD}
name=slurm__RadiationTransportFLD_Grey_Split_CosmoIonization_q05z10_sp_CosmoIonization_q05z10_spenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_Grey_Split_CosmoIonization_q05z10_sp_CosmoIonization_q05z10_spenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/CosmoIonization_q05z10_sp/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/Grey_Split/CosmoIonization_q05z10_sp/CosmoIonization_q05z10_sp.enzo
du -sh *
du -sh .
