...
thepath=${PWD}
name=slurm__RadiationTransportFLD_TurnerStoneEquil1_TurnerStoneEquil1enzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_TurnerStoneEquil1_TurnerStoneEquil1enzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/TurnerStoneEquil1/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/TurnerStoneEquil1/TurnerStoneEquil1.enzo
du -sh *
du -sh .
