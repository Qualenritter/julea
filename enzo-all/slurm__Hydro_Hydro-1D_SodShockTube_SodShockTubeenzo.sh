...
echo slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-1D_SodShockTube_SodShockTubeenzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-1D/SodShockTube/SodShockTube.enzo
du -sh *
du -sh .
