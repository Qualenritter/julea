...
thepath=${PWD}
name=slurm__RadiationTransportFLD_RadiationStreamZ1_RadiationStreamZ1enzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__RadiationTransportFLD_RadiationStreamZ1_RadiationStreamZ1enzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamZ1/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./RadiationTransportFLD/RadiationStreamZ1/RadiationStreamZ1.enzo
du -sh *
du -sh .
