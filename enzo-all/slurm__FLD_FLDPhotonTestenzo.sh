...
echo slurm__FLD_FLDPhotonTestenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__FLD_FLDPhotonTestenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__FLD_FLDPhotonTestenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__FLD_FLDPhotonTestenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__FLD_FLDPhotonTestenzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./FLD/FLDPhotonTest.enzo
du -sh *
du -sh .
