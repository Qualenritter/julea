...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-3D_NFWCoolCoreCluster_NFWCoolCoreClusterenzo"
...
cat ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NFWCoolCoreCluster/NFWCoolCoreCluster.enzo | grep -v "ResubmitOn" | grep -v "StopCPUTime" | grep -v "ResubmitCommand" > ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NFWCoolCoreCluster/NFWCoolCoreCluster.enzo.tmp
echo "ResubmitOn = 1" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NFWCoolCoreCluster/NFWCoolCoreCluster.enzo.tmp
echo "StopCPUTime = 1" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NFWCoolCoreCluster/NFWCoolCoreCluster.enzo.tmp
...
mpirun -np 6 ${HOME}/enzo-dev/src/enzo/enzo.exe ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NFWCoolCoreCluster/NFWCoolCoreCluster.enzo.tmp >> ${J_TIMER_DB_RUN}.out
