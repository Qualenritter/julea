...
echo slurm__FuzzyDarkMatter_FDMTestenzo.sh
echo $tmpdir

cat ${HOME}/.config/julea/julea-slurm__FuzzyDarkMatter_FDMTestenzo

export LD_LIBRARY_PATH=${HOME}/julea/prefix-hdf-julea/lib/:$LD_LIBRARY_PATH
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__FuzzyDarkMatter_FDMTestenzo
...
export J_TIMER_DB="${HOME}/julea/slurm__FuzzyDarkMatter_FDMTestenzo.sqlite"
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__FuzzyDarkMatter_FDMTestenzo
...
cp -r ${HOME}/enzo-dev/run/./FuzzyDarkMatter/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./FuzzyDarkMatter/FDMTest.enzo
du -sh *
du -sh .
