...
thepath=${PWD}
name=slurm__Cooling_CoolingTest_Grackle_CoolingTest_Grackleenzo
builddir="hdf-julea"
...
export J_TIMER_DB="${HOME}/julea/slurm__Cooling_CoolingTest_Grackle_CoolingTest_Grackleenzo.sqlite"
...
cp -r ${HOME}/enzo-dev/run/./Cooling/CoolingTest_Grackle/* $tmpdir
cd $tmpdir
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Cooling/CoolingTest_Grackle/CoolingTest_Grackle.enzo
du -sh *
du -sh .
