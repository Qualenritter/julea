...
cat ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo | grep -v "ResubmitOn" | grep -v "StopCPUTime" | grep -v "ResubmitCommand" > ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo.tmp1
echo "ResubmitOn = 1" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo.tmp1
echo "StopCPUTime = 1" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo.tmp1
echo "ResubmitCommand = ${HOME}/julea/enzo-all/run-continue.sh" >> ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo.tmp1


time ${HOME}/enzo-dev/src/enzo/enzo.exe ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo
