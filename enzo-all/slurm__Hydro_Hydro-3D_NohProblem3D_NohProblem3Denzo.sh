...
export J_TIMER_DB_RUN="${HOME}/julea/slurm__Hydro_Hydro-3D_NohProblem3D_NohProblem3Denzo"
...
mpirun -np 6 ${HOME}/enzo-dev/src/enzo/enzo.exe ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo.tmp >> ${J_TIMER_DB_RUN}.out
