...
export JULEA_CONFIG=${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_NohProblem3D_NohProblem3Denzo
...
mv ${HOME}/.config/julea/julea ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_NohProblem3D_NohProblem3Denzo

sleep 10s

cat ${HOME}/.config/julea/julea-slurm__Hydro_Hydro-3D_NohProblem3D_NohProblem3Denzo
...
echo $PWD
ls -la
time ${HOME}/enzo-dev/src/enzo/enzo.exe -d ${HOME}/enzo-dev/run/./Hydro/Hydro-3D/NohProblem3D/NohProblem3D.enzo
du -sh *
du -sh .
