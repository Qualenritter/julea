...
JULEA_CONFIG=~/.config/julea/julea2 ./afl/julea-server &
...
do
	mkdir -p ./afl/cov/fuzzer${i}/src/julea/julea/
	cp -r build ./afl/cov/fuzzer${i}/src/julea/julea/
	afl-fuzz -m none -S fuzzer$i -i /src/julea/julea/afl/start-files -o /src/julea/julea/afl/out ./afl/julea-test-afl-fast &
	sleep 2
done
i=10
mkdir -p ./afl/cov/fuzzer${i}/src/julea/julea/
cp -r build ./afl/cov/fuzzer${i}/src/julea/julea/
afl-fuzz -m none -M fuzzer$i -i /src/julea/julea/afl/start-files -o /src/julea/julea/afl/out ./afl/julea-test-afl-fast &
sleep 2
i=11
mkdir -p ./afl/cov/fuzzer${i}/src/julea/julea/
cp -r build ./afl/cov/fuzzer${i}/src/julea/julea/
JULEA_CONFIG=~/.config/julea/julea2 afl-fuzz -m none -M fuzzer$i -i /src/julea/julea/afl/start-files -o /src/julea/julea/afl/out ./afl/julea-test-afl &
sleep 2
i=12
mkdir -p ./afl/cov/fuzzer${i}/src/julea/julea/
cp -r build ./afl/cov/fuzzer${i}/src/julea/julea/
