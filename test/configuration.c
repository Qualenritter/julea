...
test_configuration_get(void)
{
	...
	gchar const* smd_servers[] = { "localhost", NULL };
	...
	g_key_file_set_string_list(key_file, "servers", "smd", smd_servers, 1);
	g_key_file_set_string(key_file, "object", "backend", "null");
	g_key_file_set_string(key_file, "object", "component", "server");
	...
	g_key_file_set_string(key_file, "smd", "backend", "null2");
	g_key_file_set_string(key_file, "smd", "component", "client");
	g_key_file_set_string(key_file, "smd", "path", "NULL2");
	...
	g_assert_cmpstr(j_configuration_get_smd_server(configuration, 0), ==, "localhost");
	g_assert_cmpuint(j_configuration_get_smd_server_count(configuration), ==, 1);
	...
	g_assert_cmpstr(j_configuration_get_smd_backend(configuration), ==, "null2");
	g_assert_cmpstr(j_configuration_get_smd_component(configuration), ==, "client");
	g_assert_cmpstr(j_configuration_get_smd_path(configuration), ==, "NULL2");
