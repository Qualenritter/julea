...
test_configuration_get(void)
{
	...
	gchar const* smd_servers[] = { "hostlocal", "local.host", NULL };
	...
	g_key_file_set_string(key_file, "kv", "path", "NULL");
	g_key_file_set_string(key_file, "smd", "backend", "null");
	g_key_file_set_string(key_file, "smd", "component", "server");
	g_key_file_set_string(key_file, "smd", "path", "NULL");
	...
	g_assert_cmpstr(j_configuration_get_smd_server(configuration, 1), ==, "local.host");
	...
	g_assert_cmpstr(j_configuration_get_kv_backend(configuration), ==, "null");
	g_assert_cmpstr(j_configuration_get_kv_component(configuration), ==, "client");
	g_assert_cmpstr(j_configuration_get_kv_path(configuration), ==, "NULL");

	g_assert_cmpstr(j_configuration_get_smd_backend(configuration), ==, "null");
	g_assert_cmpstr(j_configuration_get_smd_component(configuration), ==, "server");
	g_assert_cmpstr(j_configuration_get_smd_path(configuration), ==, "NULL");
