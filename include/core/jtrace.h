...
#define J_TRACE(name, ...) __attribute__((unused)) g_autoptr(JTrace) j_trace = j_trace_enter(name, __VA_ARGS__)
#define J_TRACE_FUNCTION(...) __attribute__((unused)) g_autoptr(JTrace) j_trace_function = j_trace_enter(G_STRFUNC, __VA_ARGS__)
