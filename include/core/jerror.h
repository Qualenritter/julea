...
JULEA_REGISTER_BACKEND_ERROR(JULEA_BACKEND_ERROR_BSON_APPEND_FAILED, "%s:%s: bson append failed. smd type was '%s'")
...
JULEA_REGISTER_BACKEND_ERROR(JULEA_BACKEND_ERROR_COMPARATOR_INVALID, "%s:%s: smd comparator invalid '%d'")
...
JULEA_REGISTER_BACKEND_ERROR(JULEA_BACKEND_ERROR_SMD_TYPE_INVALID, "%s:%s: smd invalid type '%d'")
...
JULEA_REGISTER_FRONTEND_ERROR(JULEA_FRONTEND_ERROR_BSON_APPEND_FAILED, "%s:%s: bson append failed. smd type was '%s'")
...
JULEA_REGISTER_FRONTEND_ERROR(JULEA_FRONTEND_ERROR_SMD_BSON_SERVER, "%s:%s: bson stored on server - no modifications, no create again, no load again%s")
JULEA_REGISTER_FRONTEND_ERROR(JULEA_FRONTEND_ERROR_SMD_TYPE_INVALID, "%s:%s: smd invalid type '%d'")
